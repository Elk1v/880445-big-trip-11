...
/* harmony import */ var _model_destinations_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/destinations.js */ "./src/model/destinations.js");
/* harmony import */ var _model_events_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/events.js */ "./src/model/events.js");
...
class Api {
  ...
  getEvents() {
    return this._load({url: `points`})
      .then(Api.toJSON)
      .then((events) => events.map(_model_events_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }

  getDestinations() {
    return this._load({url: `destinations`})
      .then(Api.toJSON)
      .then((destinations) => destinations.map(_model_destinations_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateEvent(event) {
    return this._load({
      url: `points/${event.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_events_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(event)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_events_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient);
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: BLANK_EVENT, EventCategory, SortType, UserAction, UpdateType, FilterType, MenuItem, transferTypes, activityTypes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BLANK_EVENT", function() { return BLANK_EVENT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transferTypes", function() { return transferTypes; });
...
/* harmony import */ var _view_stats_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/stats.js */ "./src/view/stats.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _presenter_trip_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/trip.js */ "./src/presenter/trip.js");
/* harmony import */ var _model_events_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/events.js */ "./src/model/events.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _model_destinations_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/destinations.js */ "./src/model/destinations.js");
/* harmony import */ var _model_offers_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/offers.js */ "./src/model/offers.js");
...
const eventsModel = new _model_events_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const destinationsModel = new _model_destinations_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const offersModel = new _model_offers_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
const menuComponent = new _view_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(pageMenuWrapper, menuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
...
const activateMenuControls = () => {
  ...
  newEventButton.addEventListener(`click`, (evt) => {
    ...
    if (statsComponent) {
      handleMenuClick(_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].ADD_NEW_EVENT);
    } else {
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_10__["default"](END_POINT, AUTHORIZATION);
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_8__["default"](controlsContainer, filterModel);
const tripPresenter = new _presenter_trip_js__WEBPACK_IMPORTED_MODULE_3__["default"](
    eventsContainer,
    eventsModel,
    filterModel,
    destinationsModel,
...
const handleMenuClick = (menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].ADD_NEW_EVENT: {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(statsComponent);
      menuComponent.resetMenuToDefaultView();
      tripPresenter.render();
      tripPresenter.addNewEvent(newEventButtonDisableToggle);
      break;
    }
    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].TABLE: {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(statsComponent);
      tripPresenter.render();
      break;
    }
    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATS: {
      tripPresenter.destroy();
      statsComponent = new _view_stats_js__WEBPACK_IMPORTED_MODULE_1__["default"](eventsModel.getEvents());
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(eventsContainer, statsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTEREND);
      break;
    }
  }
};
...
api.getDestinations()
  .then((destinations) => {
    destinationsModel.setDestinations(
        _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].DESTINATIONS_LOADED,
        destinations
    );
  });
...
api.getOffers()
  .then((offers) => {
    offersModel.setOffers(
        _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].OFFERS_LOADED,
        offers
    );
  });
...
api.getEvents()
  .then((events) => {
    eventsModel.setEvents(_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, events);
    activateMenuControls();
  })
  .catch(() => {
    eventsModel.setEvents(_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, []);
    activateMenuControls();
  });
...
/*!***************************!*\
  !*** ./src/mock/event.js ***!
  \***************************/
/*! exports provided: generateId, generateEvent, generateDestinationInfo, generateDestinationPhotos, getDestinations, transferTypes, activityTypes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateDestinationInfo", function() { return generateDestinationInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateDestinationPhotos", function() { return generateDestinationPhotos; });
...
const generateDestinationInfo = () => {
  const sentenceCount = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MIN_SENTENCE_COUNT, MAX_SENTENCE_COUNT);
...
const generateDestinationPhotos = () => {
  const photoCount = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MIN_PHOTO_COUNT, MAX_PHOTO_COUNT);
  const photos = [];
...
const generateDate = () => {
  ...
  startDate.setMinutes(startDate.getMinutes() + Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MIN_INTERVAL_BETWEEN_EVENTS, MAX_INTERVAL_BETWEEN_EVENTS));

  const endDate = new Date(startDate);
  endDate.setMinutes(endDate.getMinutes() + Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MIN_EVENT_DURATION, MAX_EVENT_DURATION));
...
const generateEvent = () => {
  const event = {};
  const category = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, 2) > 0 ? _const_js__WEBPACK_IMPORTED_MODULE_0__["EventCategory"].TRANSFER : _const_js__WEBPACK_IMPORTED_MODULE_0__["EventCategory"].ACTIVITY;

  event.id = generateId();

  if (category === _const_js__WEBPACK_IMPORTED_MODULE_0__["EventCategory"].TRANSFER) {
    event.type = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomItem"])(transferTypes);
  } else {
    event.type = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomItem"])(activityTypes);
  }
  event.destination = {
    name: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomItem"])(destinations),
  ...
  event.cost = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(2, 120) * 5;
...
class Destinations extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class Events extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_observer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/observer.js */ "./src/utils/observer.js");



class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();

    this._activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING;
  }
...
class Offers extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventNew; });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_event_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event-form.js */ "./src/view/event-form.js");
...
/* harmony import */ var _mock_event_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mock/event.js */ "./src/mock/event.js");
...
class EventNew {
  constructor(tripDaysContainer, changeData, destinationsModel, offersModel) {
    ...
    this._type = _const_js__WEBPACK_IMPORTED_MODULE_2__["BLANK_EVENT"].type;
  ...
  init(disableNewEventButton) {
    ...
    this._eventFormComponent = new _view_event_form_js__WEBPACK_IMPORTED_MODULE_1__["default"](_const_js__WEBPACK_IMPORTED_MODULE_2__["BLANK_EVENT"], destinations, this._offers);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripDaysContainer, this._eventFormComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREBEGIN);
  ...
  _handleFormSubmit(newEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR,
        Object.assign(
            {},
            newEvent,
            {id: Object(_mock_event_js__WEBPACK_IMPORTED_MODULE_4__["generateId"])()}
        )
    );
  ...
  _escKeyDownHandler(evt) {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["isEscKey"])(evt.key)) {
      evt.preventDefault();
      this.destroy();
...
/* harmony import */ var _view_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/event.js */ "./src/view/event.js");
/* harmony import */ var _view_event_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event-form.js */ "./src/view/event-form.js");
...
class Event {
  ...
  init(event) {
    ...
    this._eventComponent = new _view_event_js__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._eventComponent.setExpandButtonClickHandler(this._handleExpandButtonClick);

    this._eventFormComponent = new _view_event_form_js__WEBPACK_IMPORTED_MODULE_1__["default"](event, this._destinations, this._offers);
    ...
    if (prevEventComponent === null || prevEventFormComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._eventContainer, this._eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, prevEventComponent);
    }

    if (this._mode === Mode.EDIT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventFormComponent, prevEventFormComponent);
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevEventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevEventFormComponent);
  }
  ...
  _replaceEventToForm() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventFormComponent, this._eventComponent);
  ...
  _replaceFormToEvent() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, this._eventFormComponent);
  ...
  _handleEscKeyDown(evt) {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["isEscKey"])(evt.key)) {
      evt.preventDefault();
  ...
  _handleDeleteButtonClick(deletedEvent) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].DELETE_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR,
        deletedEvent
    );
  }
  ...
  _handleFavoriteButtonClick() {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_EVENT,
        _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].PATCH,
        Object.assign(
            {},
            this._event,
            {
  ...
  _handleFormSubmit(updatedEvent) {
    const isMinorUpdate =
      !Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["isDatesEqual"])(this._event.date.start, updatedEvent.date.start) ||
      !Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["isDatesEqual"])(this._event.date.end, updatedEvent.date.end);

    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_EVENT,
        isMinorUpdate ? _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR : _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].PATCH,
        updatedEvent
    );
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._eventFormComponent);
  }
}
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentFilter);
...
/* harmony import */ var _view_sorting_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/sorting.js */ "./src/view/sorting.js");
...
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
/* harmony import */ var _view_day_list_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/day-list.js */ "./src/view/day-list.js");
/* harmony import */ var _view_day_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/day.js */ "./src/view/day.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/event.js */ "./src/utils/event.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event.js */ "./src/presenter/event.js");
/* harmony import */ var _event_new_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./event-new.js */ "./src/presenter/event-new.js");
...
class Trip {
  constructor(
    ...
    this._offersModel = offersModel;
    this._api = api;
    this._currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].EVENT;
    ...
    this._noEventView = new _view_no_event_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._loadingView = new _view_loading_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._sortingView = null;
    this._dayListView = new _view_day_list_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    ...
    this._eventNewPresenter = new _event_new_js__WEBPACK_IMPORTED_MODULE_9__["default"](
        this._dayListView,
  ...
  addNewEvent(disableNewEventButton) {
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_7__["FilterType"].EVERYTHING);

    if (this._noEventView) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._noEventView);
    }
  ...
  _getEvents() {
    ...
    const filteredEvents = _utils_event_js__WEBPACK_IMPORTED_MODULE_6__["filter"][filterType](events);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].TIME: {
        return filteredEvents.sort(_utils_event_js__WEBPACK_IMPORTED_MODULE_6__["sortByTime"]);
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].PRICE: {
        return filteredEvents.sort(_utils_event_js__WEBPACK_IMPORTED_MODULE_6__["sortByPrice"]);
      }
      default: {
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].UPDATE_EVENT: {
        this._api.updateEvent(update)
          .then((response) => this._eventsModel.updateEvent(updateType, response));
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].ADD_EVENT: {
        this._eventsModel.addEvent(updateType, update);
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].DELETE_EVENT: {
  ...
  _handleModelUpdate(updateType, update) {
    ...
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].PATCH: {
        this._eventPresenter[update.id].init(update);
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].MINOR: {
        this._clearDayList();
        this._renderDays();
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].MAJOR: {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].OFFERS_LOADED: {
        this._isOffersLoaded = true;
        this._checkLoading();
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].DESTINATIONS_LOADED: {
  ...
  _checkLoading() {
    if (this._isDestinationsLoaded && this._isOffersLoaded) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._loadingView);
      this._renderTrip();
    }
  }
  ...
  _clearDayList() {
    ...
    this._days.forEach((day) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(day));
    this._days = [];
  }
  ...
  _clearTripContainer(resetSortType = true) {
    ...
    if (this._sortingView) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._sortingView);
    }
  ...
  _renderNoEvents() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer, this._noEventView, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderLoading() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer, this._loadingView, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderSorting() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer, this._sortingView, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTERBEGIN);
  }

  _renderDayList() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer, this._dayListView, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  _renderDay(dayView) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._eventsContainer, dayView, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  }

  _renderEvent(container, event) {
    const eventPresenter = new _event_js__WEBPACK_IMPORTED_MODULE_8__["default"](
        container,
        this._handleViewAction,
  ...
  _renderEventsByDates(eventsByDates) {
    Array.from(eventsByDates.entries()).forEach((entry, index) => {
      ...
      if (eventsForDay.length && eventsForDay.length !== 0) {
        ...
        const dayView = new _view_day_js__WEBPACK_IMPORTED_MODULE_4__["default"](dayNumber, date);
  ...
  _renderDays() {
    ...
    if (this._currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].EVENT) {
      const eventsByDates = Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_6__["groupByDates"])(events);
      this._renderEventsByDates(eventsByDates);

    } else {
      const emptyDayView = new _view_day_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: isEscKey, getRandomInteger, getRandomItem, getLocalTime, getTimeInterval, formatTimeInterval, convertToMachineFormat, localizeDate, capitalizeWord, isDatesEqual */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertToMachineFormat", function() { return convertToMachineFormat; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDatesEqual", function() { return isDatesEqual; });
...
const formatTimeInterval = (interval) => {
  const totalMinutes = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(interval).asMinutes();
  if (totalMinutes < MINUTES_IN_HOUR) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(interval).format(`mm[m]`);
  }

  const totalHours = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(interval).asHours();
  if (totalHours < HOURS_IN_DAY) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(interval).format(`hh[h] mm[m]`);
  }

  const totalDays = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(interval).asDays();
  if (totalDays < MAX_DAYS_IN_MONTH) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(interval - MILLISECONDS_IN_DAY).format(`D[D] hh[h] mm[m]`);
  }
...
const isDatesEqual = (dateA, dateB) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB);
};
...
/*!****************************!*\
  !*** ./src/utils/event.js ***!
  \****************************/
/*! exports provided: defineEventCategory, sortByPrice, sortByTime, groupByDates, filter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defineEventCategory", function() { return defineEventCategory; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupByDates", function() { return groupByDates; });
...
const defineEventCategory = (eventType) => {
  if (_const_js__WEBPACK_IMPORTED_MODULE_1__["activityTypes"].some((activityType) => activityType === eventType)) {
    return _const_js__WEBPACK_IMPORTED_MODULE_1__["EventCategory"].ACTIVITY;
  }

  return _const_js__WEBPACK_IMPORTED_MODULE_1__["EventCategory"].TRANSFER;
};

const sortByTime = (eventA, eventB) => {
  const eventADuration = Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["getTimeInterval"])(eventA.date.start, eventA.date.end);
  const eventBDuration = Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["getTimeInterval"])(eventB.date.start, eventB.date.end);
...
const filter = {
  [_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING]: (events) => events,
  [_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE]: (events) => {
    const now = new Date();

    return events.filter((event) => event.date.start.getTime() > now.getTime());
  },
  [_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST]: (events) => {
    const now = new Date();
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: renderTemplate, RenderPosition, createElement, render, replace, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class DayList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/*!*************************!*\
  !*** ./src/view/day.js ***!
  \*************************/
/*! exports provided: createDayTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createTimeTemplate = (date) => {
  return `<time class="day__date" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["convertToMachineFormat"])(date, false)}"
    >${date.toLocaleString(`en-US`, {month: `short`, day: `2-digit`})}
  </time>`;
};

const createDayTemplate = (number, date) => {
...
class DayView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _utils_event_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/event.js */ "./src/utils/event.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _mock_event_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../mock/event.js */ "./src/mock/event.js");
/* harmony import */ var _node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../node_modules/flatpickr/dist/flatpickr.min.css */ "./node_modules/flatpickr/dist/flatpickr.min.css");
/* harmony import */ var _node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_6__);
...
const createEventFormTemplate = (draftData, availableOffers) => {
  ...
  const localizedStartDate = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["localizeDate"])(start);
  const localizedEndDate = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["localizeDate"])(end);

  const transferEventTypesTemplate = _mock_event_js__WEBPACK_IMPORTED_MODULE_5__["transferTypes"]
    .map((it) => createEventTypeTemplate(it, it === type))
    .join(`\n\n`);

  const activityEventTypesTemplate = _mock_event_js__WEBPACK_IMPORTED_MODULE_5__["activityTypes"]
    .map((it) => createEventTypeTemplate(it, it === type))
    .join(`\n\n`);
...
class EventForm extends _smart_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  _destinationChoseHandler(evt) {
    ...
    const update = {
      destination: {
        info: Object(_mock_event_js__WEBPACK_IMPORTED_MODULE_5__["generateDestinationInfo"])(),
        photos: Object(_mock_event_js__WEBPACK_IMPORTED_MODULE_5__["generateDestinationPhotos"])(),
      }
    };
  ...
  _startDateFocusHandler() {
    this._destroyDatepicker();
    this._datepicker = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(
  ...
  static parseEventToDraftData(event, destinations) {
    return Object.assign(
        ...
        event,
        {
          isTransferEvent: Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_3__["defineEventCategory"])(event.type) === _const_js__WEBPACK_IMPORTED_MODULE_4__["EventCategory"].TRANSFER,
...
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/event.js */ "./src/utils/event.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
...
const createEventTemplate = (event) => {
  ...
  const isTransferEvent = Object(_utils_event_js__WEBPACK_IMPORTED_MODULE_2__["defineEventCategory"])(event.type) === _const_js__WEBPACK_IMPORTED_MODULE_1__["EventCategory"].TRANSFER;
  ...
  const eventStartTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getLocalTime"])(start);
  const eventEndTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getLocalTime"])(end);
  const eventDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["formatTimeInterval"])(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getTimeInterval"])(start, end));
  const eventStartDatetime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["convertToMachineFormat"])(start);
  const eventEndDatetime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["convertToMachineFormat"])(end);
...
class Event extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event) {
    super();
    this._event = event;
...
const createFilterItemTemplate = (filter, currentFilterType) => {
  const filterName = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["capitalizeWord"])(filter);
...
const createFilterTemplate = (currentFilterType) => {
  const filterItemsTemplate = Object
    .values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"])
  ...
  return (
    `<nav class="trip-controls__trip-tabs  trip-tabs">
      <a
        ...
        href="#"
        data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE}"
      >Table</a>
      <a class="trip-tabs__btn" href="#" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS}">Stats</a>
    </nav>`
  );
};
...
class Menu extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._activeItem = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE;
  ...
  _toggleMenuItem(item) {
    const tableButton = this
      .getElement()
      .querySelector(`[data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE}"]`);
    const statsButton = this
      .getElement()
      .querySelector(`[data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS}"]`);

    switch (item) {
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE: {
        tableButton.classList.add(ACTIVE_CLASS);
        statsButton.classList.remove(ACTIVE_CLASS);
        this._activeItem = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE;
        break;
      }
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS: {
        tableButton.classList.remove(ACTIVE_CLASS);
        statsButton.classList.add(ACTIVE_CLASS);
        this._activeItem = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS;
        break;
      }
    }
  }
  ...
  resetMenuToDefaultView() {
    this._toggleMenuItem(_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE);
  }
...
const createSortingTemplate = (sortType) => {
  const dayTextContent = sortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? DayColumnHead.DAY : DayColumnHead.EMPTY;

  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      <span class="trip-sort__item  trip-sort__item--day">${dayTextContent}</span>

      <div class="trip-sort__item  trip-sort__item--event">
        <input id="sort-event" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-event" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}" ${sortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT ? `checked` : ``}>
        <label class="trip-sort__btn" for="sort-event">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" ${sortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? `checked` : ``}>
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" ${sortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? `checked` : ``}>
...
class Sorting extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _dayColumnHeadToggle(sortType) {
    ...
    if (sortType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT) {
...
const renderMoneyChart = (moneyCtx, events) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(moneyCtx, {
...
const renderTransportChart = (transportCtx, events) => {
  ...
  events.forEach((event) => {
    const isActivityEvent = _const_js__WEBPACK_IMPORTED_MODULE_3__["activityTypes"].some((type) => type === event.type);
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(transportCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_1___default.a],
    type: `horizontalBar`,
    data: {
      labels: chartDataLabels,
...
const renderTimeSpendChart = (timeSpendCtx, events) => {
  ...
  events.forEach((event) => {
    const eventDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["getTimeInterval"])(event.date.start, event.date.end);
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(timeSpendCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_1___default.a],
    type: `horizontalBar`,
    data: {
      labels: chartDataLabels,
    ...
    options: {
      plugins: {
        datalabels: {
          ...
          anchor: `end`,
          align: `start`,
          formatter: (val) => `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["formatTimeInterval"])(val)}`
        }
      },
      title: {
        display: true,
...
class Stats extends _abstract_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(events) {
    super();
